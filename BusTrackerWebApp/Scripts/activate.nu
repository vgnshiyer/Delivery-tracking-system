...
let virtual-env = "E:\Devops\K8S projects\Confluent_on_k8s\BusTrackerApp\WebApp"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "E:\Devops\K8S projects\Confluent_on_k8s\BusTrackerApp\WebApp\Scripts\deactivate.nu"
