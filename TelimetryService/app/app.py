...
inputqueue = os.environ.get('INP_QUEUE')
outputqueue = os.environ.get('OP_QUEUE')
...
def main():
    ...
    mq_client = Consumer.RabbitMQConsumer(mq_url, inputqueue, outputqueue, persist_data=False, mongo_dest=mongo_endpt)
    mq_client.connect()
